    ...
    <Card className="w-full max-w-[560px] ring-0 rounded-2xl bg-white p-0 gap-0 overflow-hidden">
      ...
      <CardHeader className="px-6 py-5 pb-4 flex flex-row items-center justify-between gap-4 bg-white">
        <div className="flex flex-col gap-2">
          <div>
            <span
              ...
              `}
            >
              <span className={`w-1.5 h-1.5 rounded-full ${CAT["actu"].dot}`} />
              Actualité
            </span>
          </div>
        ...
        {onClose && (
          <Button
            ...
            size="icon"
            onClick={onClose}
            className="rounded-full h-8 w-8 text-gray-400 hover:text-gray-600 hover:bg-gray-100 cursor-pointer"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
      ...
      <CardContent className="px-6 py-5 flex flex-col gap-6 overflow-y-auto max-h-[calc(90vh-80px)]">
        ...
        <div className="flex flex-col gap-2">
          <Label
            htmlFor="titre"
            className="text-[10.5px] font-bold tracking-[0.1em] uppercase text-gray-400"
          >

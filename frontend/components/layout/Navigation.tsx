...
function Logo() {
  return (
    ...
    >
      {/* Drapeau bicolore compact */}
      <div className="relative size-8 rounded-[9px] overflow-hidden shadow-md shadow-black/20 shrink-0 flex">
        <span className="flex-1 bg-[#e8251a]" />
        <span className="flex-1 bg-[#007a38]" />
      </div>
      ...
      <div className="leading-none">
        <div className="flex items-baseline gap-[1px]">
          <span
            className="font-bold text-[17px] tracking-[-0.5px] text-foreground"
            style={{ fontFamily: "var(--font-heading)" }}
          >
            mada
          </span>
          <span
            className="font-bold text-[17px] tracking-[-0.5px] text-[#e8251a]"
            style={{ fontFamily: "var(--font-heading)" }}
          >
            smart
          </span>
        ...
        <div
          className="text-[8px] font-semibold tracking-[0.18em] uppercase text-muted-foreground mt-[1px]"
...
function MobileNavItem({
  ...
  return (
    <motion.a
      ...
      transition={{ delay: index * 0.06 + 0.1, duration: 0.28, ease: "easeOut" }}
    >
          ...
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            <SheetContent side="right" className="w-72 p-0">
              ...
              >
                ...
                <Button
                  className="w-full h-10 rounded-xl font-semibold gap-2 bg-[#007a38] hover:bg-[#005a2a] text-white shadow-lg shadow-[#007a38]/25"
                >
